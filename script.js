...
const unifiedTimes = [
  ...
  { time: "12.50 - 1.30", labOnly: true }, // 🔒 Lab-only slot
...
const courseData = {
  ...
  ECE1003: {
    ...
    credits: 4,
    theoryTeachers: [
      { name: "Khairnar Vikas Vishnu", slots: ["C1", "TC1"] },
      { name: "Atul Shankar Mani Tripathi", slots: ["C1", "TC1"] },
      { name: "Abdul Kayom Md Khairuzzaman", slots: ["C1", "TC1"] },
      { name: "Sambhudutta Nanda", slots: ["C1", "TC1"] },
      { name: "D HEPZIBHA RANI", slots: ["C1", "TC1"] },
      { name: "Nuthakki Venkata Rajasekhar", slots: ["C2", "TC2"] },
      { name: "Khairnar Vikas Vishnu", slots: ["C2", "TC2"] },
      { name: "Manish Kumar Singh", slots: ["C2", "TC2"] },
      { name: "PILLEM RAMESH", slots: ["C2", "TC2"] },
      { name: "MAHABOOB KHAN PATHAN", slots: ["C2", "TC2"] },
      { name: "VENKATESWARA RAO BHUKYA", slots: ["C2", "TC2"] },
      { name: "Atul Shankar Mani Tripathi", slots: ["D1", "TD1"] },
      { name: "Abdul Kayom Md Khairuzzaman", slots: ["D1", "TD1"] },
      { name: "Sambhudutta Nanda", slots: ["D1", "TDD1"] },
      { name: "Lakshminarayana Janjanam", slots: ["D1", "TDD1"] },
      { name: "Khairnar Vikas Vishnu", slots: ["D2", "TD2"] },
      { name: "Lakshminarayana Janjanam", slots: ["D2", "TD2"] },
      { name: "Abdul Kayom Md Khairuzzaman", slots: ["D2", "TDD2"] },
      { name: "Maheshuni Sankush Krishna", slots: ["D2", "TDD2"] },
      { name: "Nuthakki Venkata Rajasekhar", slots: ["F1", "TF1"] },
      { name: "Manish Kumar Singh", slots: ["F1", "TF1"] },
      { name: "DARAM SRIKANTH", slots: ["F1", "TF1"] },
      { name: "Lakshminarayana Janjanam", slots: ["F1", "TF1"] },
      { name: "GANDHAM SAI SRAVANTHI", slots: ["F1", "TFF1"] },
      { name: "Atul Shankar Mani Tripathi", slots: ["F2", "TF2"] },
      { name: "Maheshuni Sankush Krishna", slots: ["F2", "TF2"] },
      { name: "VENKATESWARLU G", slots: ["F2", "TF2"] },
      { name: "KESANAPALLI AKSA RANI", slots: ["F2", "TF2"] },
      { name: "Manish Kumar Singh", slots: ["F2", "TF2"] },
      { name: "THOTAPALLI VINAYAKUMAR", slots: ["F2", "TFF2"] },
      { name: "SATHISH MOTHE", slots: ["C1", "TC1"] },
    ],
    labTeachers: [
      { name: "MS.G.P.S. PRASHANTHI", slots: ["L13", "L14"] },
      { name: "CHENGALVA SRIHARI", slots: ["L15", "L16"] },
      { name: "S. VIJAYADHEESWAR REDDY", slots: ["L19", "L20"] },
      { name: "D HEPZIBHA RANI", slots: ["L1", "L2"] },
      { name: "PILLEM RAMESH", slots: ["L21", "L22"] },
      { name: "Sambhudutta Nanda", slots: ["L23", "L24"] },
      { name: "VENKATESWARLU G", slots: ["L25", "L26"] },
      { name: "SANDEEP SARJERAO GODHADE", slots: ["L27", "L28"] },
      { name: "CHENGALVA SRIHARI", slots: ["L29", "L30"] },
      { name: "Lakshminarayana Janjanam", slots: ["L31", "L32"] },
      { name: "SHAIK LAL JOHN BASHA", slots: ["L33", "L34"] },
      { name: "Manish Kumar Singh", slots: ["L35", "L36"] },
      { name: "S. VIJAYADHEESWAR REDDY", slots: ["L37", "L38"] },
      { name: "D HEPZIBHA RANI", slots: ["L39", "L40"] },
      { name: "SHAIK LAL JOHN BASHA", slots: ["L3", "L4"] },
      { name: "VENKATESWARA RAO BHUKYA", slots: ["L41", "L42"] },
      { name: "VENKATESWARLU G", slots: ["L43", "L44"] },
      { name: "NAGA RAJU BATHULA", slots: ["L47", "L48"] },
      { name: "NAGA RAJU BATHULA", slots: ["L49", "L50"] },
      { name: "VENKATESWARA RAO BHUKYA", slots: ["L51", "L52"] },
      { name: "Atul Shankar Mani Tripathi", slots: ["L53", "L54"] },
      { name: "SATHISH MOTHE", slots: ["L55", "L56"] },
      { name: "POTHURAJU SURESH", slots: ["L5", "L6"] },
      { name: "S. VIJAYADHEESWAR REDDY", slots: ["L63", "L64"] },
      { name: "NAGA RAJU BATHULA", slots: ["L65", "L66"] },
      { name: "POTHURAJU SURESH", slots: ["L7", "L8"] },
      { name: "D HEPZIBHA RANI", slots: ["L9", "L10"] },
      { name: "GANDHAM SAI SRAVANTHI", slots: ["L45", "L46"] },
      { name: "SANDEEP SARJERAO GODHADE", slots: ["L11", "L12"] },
      { name: "THOTAPALLI VINAYAKUMAR", slots: ["L21", "L22"] },
      { name: "THOTAPALLI VINAYAKUMAR", slots: ["L45", "L46"] },
      { name: "THOTAPALLI VINAYAKUMAR", slots: ["L51", "L52"] },
      { name: "DARAM SRIKANTH", slots: ["L53", "L54"] },
    ],
  },
};
